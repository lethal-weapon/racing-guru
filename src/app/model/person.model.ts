...
export const JOCKEYS = [
  ...
  // new Person('NIA', '1999-07-30', 'Nishimura', 'Atsuya', 'A. Nishimura', 'JPN', 'Club', '', 0),
  // new Person('SAR', '1997-05-31', 'Sakai', 'Ryusei', 'R. Sakai', 'JPN', 'Club', '', 0),
  // new Person('IY', '1974-03-12', 'Iwata', 'Yasunari', 'Y. Iwata', 'JPN', 'Club', '', 3),
  // new Person('MTA', '1998-03-30', 'Marquand', 'Tom', 'T. Marquand', 'GB', 'Club', '', 0),
  // new Person('MLT', '1988-10-20', 'Morris', 'Luke', 'L. Morris', 'GB', 'Club', '', 0),
